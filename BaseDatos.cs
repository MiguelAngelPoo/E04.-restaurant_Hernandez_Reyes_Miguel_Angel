...
namespace Comanda
{
    ...
    {   //listas 
        ...
        public BaseDatos()
        {   //instancia y llamada de la lista
            listamenu = new List<Menu>();
            ConstruirMenu();
        }

        private void ConstruirMenu()
        {//elementos de la lista Menu
            listamenu = new List<Menu>
            ...
            {//lista de elementos de ensaldas 
            ...
            {//lista de elementos de aperitivo , su menu de opciones
            ...
            {//lista de elementos de carnes , su menu de opciones
            ...
            {//lista de elementos de pescado , su menu de opciones
            ...
            {//lista de elementos de pollo , su menu de opciones
            ...
            {//lista de elementos de pastas , su menu de opciones
            ...
            {//lista de elementos de Sandwichs , su menu de opciones
            ...
            {//lista de elementos de paninis , su menu de opciones
            ...
            {//lista de elementos de postres , su menu de opciones
            ...
            {//lista de elementos de bebidas , su menu de opciones
